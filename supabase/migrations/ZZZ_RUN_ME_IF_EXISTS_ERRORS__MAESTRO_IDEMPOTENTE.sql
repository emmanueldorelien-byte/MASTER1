-- ============================================================
-- SCRIPT MAESTRO IDEMPOTENTE — Masterclass AI
--
-- Ejecuta TODO el esquema de una sola vez. NO FALLA aunque
-- algunas tablas/columnas/funciones ya existan de ejecuciones
-- previas. Es 100% seguro.
--
-- Usa este archivo EN VEZ de ir ejecutando cada migración
-- suelta (que fallan por "already exists").
-- ============================================================

-- ============================================================
-- 1. TABLA: enskripsyon (inscripciones a la masterclass)
-- ============================================================
...
-- Columna nueva: certificate_unlocked (20260810 — unlock admin)
...
-- (No añadimos políticas de lectura pública porque se accede VIA
-- funciones RPC SECURITY DEFINER, que saltan RLS correctamente.)

-- ============================================================
-- 2. TABLA: admin_settings (título, total_spots, fecha live…)
-- ============================================================
...
INSERT INTO public.admin_settings (key, value) VALUES
  ('total_spots', '1000'),
  ('training_title', 'Masterclass AI: Kreye Kontni & Fè Aplikasyon'),
  ('whatsapp_admin', ''),
  ('whatsapp_message', 'Bonjou! Mwen ta renmen resevwa aksè a modil "{MODULE_TITLE}" nan Masterclass AI la. Tanpri di m ki pri a ak kijan pou m peye.')
ON CONFLICT (key) DO NOTHING;

-- ============================================================
-- 3. TABLA: prompts (colección de prompts para el admin)
-- ============================================================
...
-- ============================================================
-- 4. TABLA: modules (contenido de cada módulo con fecha)
-- ============================================================
...
-- ============================================================
-- 5. FUNCIÓN: plas_ki_rete() — plazas restantes (configurable)
-- ============================================================
...
-- ============================================================
-- 6. FUNCIÓN: enskri_patisipan() — nueva inscripción
-- ============================================================
...
-- ============================================================
-- 8. FUNCIÓN: module_is_completed() — módulo pasado o no
-- ============================================================
...
-- ============================================================
-- 9. FUNCIÓN: verifye_sertifika() — NUEVA, para la página /verify
-- ============================================================
...
-- ============================================================
-- FIN — Todo listo. No hay más "already exists" possible aquí.
-- ============================================================
